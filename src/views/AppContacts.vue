...
<form class="text-start" @submit.prevent="sendMessage()">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="name" :class="{ 'is-invalid': errors.name }" id="name"
            aria-describedby="text-name" placeholder="Inserisci il Nome" v-model="name" minlength="3" required>
    ...
    <div class="mb-3">
        ...
        <input type="email" class="form-control" name="email" :class="{ 'is-invalid': errors.email }" id="email"
            aria-describedby="email" placeholder="Inserisci Email" v-model="email"
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control" name="message" :class="{ 'is-invalid': errors.message }" id="message"
            placeholder="Inserisci Messaggio" v-model="message" minlength="10" required></textarea>
        <p class="text-danger" v-for="(error, index) in errors.name" :key="`name-error-${index}`">
            {{ error }}
        </p>
    </div>
